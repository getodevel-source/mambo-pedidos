# Mambo Pedidos 📦 (v1.0.0 (Stable))

[![Version](https://img.shields.io/badge/version-v1.0.0 (Stable)-orange.svg)](https://github.com/getodevel-source/mambo-pedidos/releases)
