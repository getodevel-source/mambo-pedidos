...
function testCalculator() {
  ...
  assert(Math.abs(d2d.summary.totalPuertaUsd - 158.760375) < 1e-9, 'Puerta a puerta: total exacto 158.760375 USD (CIF 116.5 + tributos 42.26)');
  assert(Math.abs(d2d.summary.totalPuertaConIvaUsd - 186.895125) < 1e-9, 'Puerta a puerta: total con IVA 186.895125 USD');
