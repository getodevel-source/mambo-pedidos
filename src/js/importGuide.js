...
// Builder de pasos (hoisted: MARITIMO/COURIER lo usan directo, sin wrappers).
function pasoSeco(id, titulo, descripcion, responsable, costoUsd, plazo, fuente, requiere) {
...
const ImportGuide = {
  ...
  // Los pasos son datos (builder hoisted pasoSeco, sin wrappers): MARITIMO y
  // COURIER se construyen con llamadas directas.

  MARITIMO: [
    pasoSeco('orden-compra', 'Orden de compra con el proveedor (pro forma)',
    ...
    pasoSeco('pago', 'Pago al proveedor (TT / carta de crédito)',
    ...
    pasoSeco('produccion', 'Producción e inspección de calidad (opcional)',
    ...
    pasoSeco('documentacion', 'Documentación de embarque',
    ...
    pasoSeco('flete', 'Flete internacional (forwarder)',
    ...
    pasoSeco('arribo', 'Arribo a puerto/aeropuerto',
    ...
    pasoSeco('despachante', 'Contratar despachante de aduana',
    ...
    pasoSeco('sim', 'Registro del despacho en SIM (digitalización)',
    ...
    pasoSeco('ncm-aforo', 'Clasificación NCM y aforo',
    ...
    pasoSeco('tributos', 'Pago de tributos (DI, TE, IVA, IVA adicional, Ganancias, IIBB)',
    ...
    pasoSeco('deposito', 'Depósito fiscal / TCA (almacenaje + THC)',
    ...
    pasoSeco('levante', 'Levante y retiro',
    ...
    pasoSeco('recepcion', 'Conteo de recepción + crédito fiscal en DDJJ',
  ...
  COURIER: [
    pasoSeco('compra', 'Compra directa al proveedor',
    ...
    pasoSeco('despacho-origen', 'El vendedor despacha con el courier',
      'DHL/FedEx/UPS: pasá dirección, DNI/CUIT y declaración de contenido. Te dan el tracking.',
      'proveedor', 0, '1-3 días', 'couriers ✓'),
    pasoSeco('limites', 'Chequeo de límites del régimen courier',
    ...
    pasoSeco('transito', 'Tránsito aéreo internacional',
      '2 a 7 días hasta Argentina. Seguilo con el tracking del courier.',
      'courier', 0, '2-7 días', 'couriers ⚠️'),
    pasoSeco('arribo-simplificado', 'Arribo: el courier despacha solo',
    ...
    pasoSeco('tributos-simplificados', 'Tributos simplificados (solo uso personal)',
    ...
    pasoSeco('entrega', 'Entrega y verificación contra factura',
      'Recibí, contá contra la factura del vendedor y guardala para contabilidad.',
      'courier', 0, '1 día', 'práctica ✓'),
    pasoSeco('registro', 'Registrar la importación en la app',
  ...
  COURIER_REVENTA_AVISO: {
    id: 'regimen-fiscal', titulo: 'Régimen fiscal: uso comercial',
    descripcion: 'El régimen simplificado courier rige "sin finalidad comercial" (Decreto 1065/2024 Art. 1º). Como este envío es para reventa, la app lo calcula con la matriz NCM completa (DI + TE + IVA + IVA adicional + Ganancias + IIBB): el courier despacha por cuenta y orden y te los factura antes de entregar.',
    responsable: 'vos', costoUsd: 0, plazo: '—', fuente: 'Decreto 1065/2024 Art. 1º ✓ (BO 02/12/2024)'
  },
  ...
  COURIER_TRIBUTOS_COMPLETOS: {
    id: 'tributos-completos', titulo: 'Tributos completos (matriz NCM)',
    descripcion: 'Con finalidad comercial el simplificado no aplica: pagás DI + TE + IVA + IVA adicional + Ganancias + IIBB según el NCM de cada producto (la app ya los calcula). El courier los liquida por cuenta y orden.',
    responsable: 'courier', costoUsd: 0, plazo: 'antes de entregar', fuente: 'Decreto 1065/2024 Art. 1º ✓ + matriz NCM ✓',
    requiere: [{ queFalta: 'CIF conocido (flete + seguro definidos)', impacto: 'sin CIF real los tributos no son los reales', check: (p, st, meta) => meta.cifUsd != null }]
  },
  ...
  LITIO_AEREO: {
    id: 'litio-aereo', titulo: 'Batería de litio: recargo DG y documentación',
    descripcion: 'Envío aéreo con baterías de litio (inalámbricos): el transportista aplica recargo de mercadería peligrosa (IATA DG) y exige declaración. El recargo (USD 75) ya está en el motor.',
    responsable: 'courier', costoUsd: 75, plazo: 'al cotizar', fuente: 'IATA ⚠️ verificar excepción batería integrada'
  },
  ...
  _planSteps(regimen, proposito, items, st) {
    ...
    if ((regimen === 'maritimo' || proposito === 'reventa') && ImportGuide.tieneInalambricos(items)) {
      ...
      const conEnacom = pasoSeco('enacom', 'Homologación ENACOM antes de vender',
    ...
    if (regimen === 'courier' && proposito === 'reventa') {
      pasos.unshift(ImportGuide.COURIER_REVENTA_AVISO);
    ...
    if ((st.transporte === 'aereo' || st.transporte === 'courier') && ImportGuide.tieneInalambricos(items)) {
      pasos.push(Object.assign({}, ImportGuide.LITIO_AEREO, { responsable: regimen === 'maritimo' ? 'forwarder' : 'courier' }));
    }
    return pasos;
  },
